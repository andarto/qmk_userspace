...
/* Qwerty Base Layer
 * ,---------------------------------------------------------------------------------------------.
 * | LANG/Esc |   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |   I  |   O  |   P  | LANG/Bksp  |
 * | SYMB/Tab |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  | SYMB/Del   |
 * | Shft/App |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Shft/Enter |
 * | LCtrl    | GUI  | LAlt | LANG |  OSM |    Space    | NAVI |  OSM | RAlt | FUNC | RCtrl      |
 * `---------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid_wrapper(
    LT(_LANG, KC_ESC), _________________QWERTY_L1_________________, _________________QWERTY_R1_________________, LT(_LANG, KC_BSPC),
...
/* KayNeo (adapted) Base Layer
 * ,--------------------------------------------------------------------------------------------.
 * | LANG/Esc |   K  |   .  |   A  |   ,  |   Y  |   P  |   D  |   L  |   M  |   J  | LANG/Bksp |
 * | SYMB/Tab |   H  |   O  |   E  |   I  |   U  |   G  |   T  |   R  |   N  |   S  | SYMB/Del  |
 * | Shft/App |   Z  |   Q  |   #  |   X  |   /  |   B  |   C  |   W  |   V  |   F  | Shft/Enter|
 * |  LCtrl   | LWin | LAlt |  OSM | NAVI |    Space    | NAVI |  OSM | RAlt | FUNC | RCtrl     |
 * `--------------------------------------------------------------------------------------------'
 */
[_KAYNEO] = LAYOUT_planck_grid_wrapper(
    LT(_LANG, KC_ESC), _________________KAYNEO_L1_________________, _________________KAYNEO_R1_________________, LT(_LANG, KC_BSPC),
 ...
 * | SFT   |  A   |  S   |  D   |  F   |  G   |  H   |  J   |  K   |  L   |  ;   | ShEnt    |
 * | LCtrl |  Z   |  X   |  C   |  V   | SPC  |  B   |  N   |  M   |  ,   |  .   | GAME_OFF |
 * `----------------------------------------------------------------------------------------'
 */
[_GAME] = LAYOUT_planck_grid_wrapper(
    KC_ESC,  __________________GAME_L1__________________, __________________GAME_R1__________________, KC_BSPC,
    KC_TAB,  __________________GAME_L2__________________, __________________GAME_R2__________________, KC_ENT,
    KC_LSFT, __________________GAME_L3__________________, __________________GAME_R3__________________, LT(_OSM, KC_ENT),
    KC_LCTL, __________________GAME_L4__________________, __________________GAME_R4__________________, GAME_OFF
),
...
[_SYMB] = LAYOUT_planck_grid_wrapper(
    N_CIRC,  __________________SYMB_L1__________________, __________________SYMB_R1__________________, KC_INS,
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_NAVI] = LAYOUT_planck_grid_wrapper(
    KC_LNUM, __________________NAVI_L1__________________, __________________NAVI_R1__________________, KC_DEL,
...
[_PROG] = LAYOUT_planck_grid_wrapper(
...
[_LANG] = LAYOUT_planck_grid_wrapper(
 ...
 */
[_OSM] = LAYOUT_planck_grid_wrapper(
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |MUSmod|Aud on|Audoff|AGnorm|AGswap|Qwerty|KayNeo| Neo  |GameON|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______,   MU_TOGG, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  KAYNEO,  GAME_ON, _______, _______,
